  ...
  frameworks: [
    {
      ...
      language: 'js',
      path: 'src/templates/backend/express-project',
    },
    {
      name: 'Fastify',
      templateName: 'fastify-project',
      language: 'js',
      path: 'src/templates/backend/fastify-project',
    },
    {
      name: 'NestJS',
      templateName: 'nest-project',
      language: 'ts',
      path: 'src/templates/backend/nest-project',
    },
  ],
};
  ...
  frameworks: [
    {
      ...
      language: 'ts',
      path: 'src/templates/backend/next-project',
    },
    {
      name: 'Vue.js',
      templateName: 'vue-project',
      language: 'ts',
      path: 'src/templates/backend/vue-project',
    },
    {
      name: 'Svelte',
      templateName: 'svelte-project',
      language: 'js',
      path: 'src/templates/backend/svelte-project',
    },
    {
      name: 'Astro.js',
      templateName: 'astro-project',
      language: 'js',
      path: 'src/templates/backend/astro-project',
    },
  ],
};
  ...
  licenses: [
    {
      ...
      path: 'src/templates/licenses/apache-2.0',
    },
    {
      name: 'BSD 2-Clause License',
      templateName: 'bsd-2-clause',
      path: 'src/templates/licenses/bsd-2-clause',
    },
    {
      name: 'BSD 3-Clause License',
      templateName: 'bsd-3-clause',
      path: 'src/templates/licenses/bsd-3-clause',
    },
    {
      name: 'GNU General Public License v3.0',
      templateName: 'gpl-3.0',
      path: 'src/templates/licenses/gpl-3.0',
    },
    {
      name: 'ISC License',
      templateName: 'isc',
      path: 'src/templates/licenses/isc',
    },
    {
      name: 'GNU Lesser General Public License v3.0',
      templateName: 'lgpl-3.0',
      path: 'src/templates/licenses/lgpl-3.0',
    },
    {
      name: 'MIT License',
      templateName: 'mit',
      path: 'src/templates/licenses/mit',
    },
    {
      name: 'Unlicense',
      templateName: 'unlicense',
      path: 'src/templates/licenses/unlicense',
    },
  ],
};
